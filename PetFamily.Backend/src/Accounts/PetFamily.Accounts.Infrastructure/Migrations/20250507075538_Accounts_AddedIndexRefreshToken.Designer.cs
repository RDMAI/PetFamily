...
namespace PetFamily.Accounts.Infrastructure.Migrations
{
    ...
    [Migration("20250507075538_Accounts_AddedIndexRefreshToken")]
    partial class Accounts_AddedIndexRefreshToken
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.ParticipantAccount", b =>
                {
                    ...
                    b.PrimitiveCollection<List<Guid>>("FavouritePets")
                        .IsRequired()
                        .HasColumnType("uuid[]")
                        .HasColumnName("favourite_pets");
            ...
            modelBuilder.Entity("PetFamily.Accounts.Domain.RefreshSession", b =>
                {
                    b.HasOne("PetFamily.Accounts.Domain.User", "User")
                        .WithOne()
                        .HasForeignKey("PetFamily.Accounts.Domain.RefreshSession", "UserId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired()
